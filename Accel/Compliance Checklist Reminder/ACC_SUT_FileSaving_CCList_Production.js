     ...
     // alert('cclist post'+cclist)
	      if(file)
	      {
              ...
              alert('File ID '+id)
	 		  ...
	 		  response.write('<html><head><title>File Uploaded</title></head><body><script language="JavaScript" type="text/javascript">window.opener.values_Set("'+File_Name+','+linenum+','+id+','+cclist+'"); window.close();</script></body></html>');		
	      }	  
