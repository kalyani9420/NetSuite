 ...
 */
define(["N/ui/serverWidget", "N/search" , "N/encode" , "N/file"], /**
    * @param{currentRecord} currentRecord
    */ (serverWidget, search , encode , file) => {
     /**
       ...
       if (scriptContext.request.method === "GET") {
         ...
         for (var index = 0; index < InvesteeResult.length; index++) {
          sublist.setSublistValue({
            id: "custpage_investeeview",
            line: index,
            value: '<a href=https://5095851.app.netsuite.com/app/common/custom/custrecordentry.nl?rectype=3&id=' + InvesteeResult[index].InvesteeID + '>' + 'View' + '</a>'
          });
           sublist.setSublistValue({
             id: "custpage_investeename",
             line: index,
